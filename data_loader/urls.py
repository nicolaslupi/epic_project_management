...
urlpatterns = [
    ...
    path('retirar_item/<int:item>', views.retirar_item, name='retirar_item'),
    path('retiros/', views.retiros, name='retiros'),
    path('edit_retiro/<int:id>', views.edit_retiro, name='edit_retiro'),
    ...
    path('ajax/load-subtypes/', views.load_subtypes, name='ajax_load_subtypes'), # AJAX
    ...
    path('view_retiro/<int:id>', views.view_retiro, name='view_retiro'),
    path('view_compra/<int:id>', views.view_compra, name='view_compra'),
